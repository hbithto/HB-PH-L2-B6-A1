...
1. interface এক্সটেন্ড করার জন্য তৈরি এবং type হলো আরও ফ্লেক্সিবল যা ইন্টারসেকশন ব্যবহার করে:
...
2. interface ডিক্লেয়ারেশন মার্জিং সাপোর্ট করে; কিন্তু type করে না:
...
4. interface class এর সাথে ভাল কাজ করে:
