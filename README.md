...
---
**_interface এক্সটেন্ড করার জন্য তৈরি এবং type হলো আরও ফ্লেক্সিবল যা ইন্টারসেকশন ব্যবহার করে:_**
...
---
**_interface ডিক্লেয়ারেশন মার্জিং সাপোর্ট করে; কিন্তু type করে না:_**
...
---
**_type আরও ফ্লেক্সিবল এবং object-এর চেয়ে বেশি রিপ্রেজেন্ট করতে পারে:_**
যেমন:
...
---
**_interface class এর সাথে ভাল কাজ করে:_**
